		...
		<div className="px-2 py-1 rounded-xl absolute left-4 top-18 mt-4 z-50 border border-1 border-gray-300 bg-white shadow flex flex-row">
			...
			<div className="flex flex-row gap-1 items-center">
				{[
					...
					<div
						key={label}
						className="group rounded-md p-2 transition-colors duration-150 cursor-pointer hover:bg-blue-100"
						title={label}
					>
			...
			<div className="flex flex-row items-center">
				...
				].map(({ Icon, label, isDelete }, idx) => (
					<div
						key={label}
						className={
							isDelete
								? 'group rounded-md p-2 transition-colors duration-150 cursor-pointer bg-white hover:bg-red-100'
								: 'group rounded-md p-2 transition-colors duration-150 cursor-pointer hover:bg-blue-100'
						}
						title={label}
					>
						<Icon
